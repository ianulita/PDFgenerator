...
namespace Acidgreen\PreOrder\Plugin\Controller\Ajax;
...
class Media
{
     ...
     * @var
     */
    protected $selectedChildProduct;
    ...
    public function afterExecute(\Magento\Swatches\Controller\Ajax\Media $object, $text)
    {
        ...
        if ($product) {
            ...
            $productMedia['product'] = $this->selectedChildProduct;
        }
    ...
    protected function getProductVariationWithMedia(Product $currentConfigurable, array $attributes)
    {
        ...
        if($product) {
            $this->selectedChildProduct = $product->getId();
        }
